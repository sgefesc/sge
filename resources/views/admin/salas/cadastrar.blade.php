...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="/administrativo/locais/salas/{{$local->id}}">Salas</a></li>
 
</ol>


  <div class="title-block">
        <h3 class="title"> <i class=" fa fa-asterisk "></i> Nova sala em: {{$local->nome}} </h3>
	 ...
	 {{csrf_field()}}
        ...
        @include('inc.errors')
			<div class="form-group row"> 
				...
				<div class="col-sm-2"> 
					<input type="text" class="form-control boxed" name="nome" id="nome" maxlength="30" required="required" placeholder="12 Audiório"> 
				</div>
				<label class="col-sm-2 form-control-label text-xs-right" for="metragem">
					Tamanho
				</label>
				<div class="col-sm-2"> 
				<input type="text" class="form-control boxed" id="metragem" name="metragem" maxlength="20" placeholder="Em m²"> 
				</div>
				<label class="col-sm-2 form-control-label text-xs-right" for="capacidade">
					Capacidade
				</label>
				<div class="col-sm-2"> 
					<input type="text" class="form-control boxed" name="capacidade" id="capacidade" maxlength="200" placeholder="pessoas" > 
				</div>
			</div>
			<div class="form-group row"> 
				...
				<div class="col-sm-10"> 
					<textarea class="form-control boxed" id="obs" name="obs" maxlength="300" rows="4" placeholder="Sala usada para tal coisa."></textarea>
			...
			<div class="form-group row"> 
				...
				<div class="col-sm-10"> 
				<input type="text" class="form-control boxed" id="gps" name="gps" maxlength="20" placeholder="URL da posição no Maps"> 
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<label class="col-sm-2 form-control-label ">
					<input type="checkbox" name="locavel" value="s" title="Estará disponível para locação?"> 
					<span title="Estará disponível para locação?">Locavel?</span> 
					
				</label>
				<label class="col-sm-3 form-control-label "> 
						<input type="radio" name="status" value="funcionando" checked> Ativa &nbsp; &nbsp;
						<input type="radio" name="status" value="parada"> Parada 
				</label>
