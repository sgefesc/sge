...
<div class="title-block">
    <h3 class="title"> Nova da ficha técnica <span class="sparkline bar" data-type="bar"></span> </h3>
	<p class="title-description"> Baseada na ficha <a href="/fichas/visualizar/{{$ficha->id}}">#{{$ficha->id}}</a> </p>
</div>
@include('inc.errors')
<form name="item" action="/fichas/cadastrar" method="POST">
    <div class="card card-block">
		...
		<div class="form-group row"> 
			...
			<div class="col-md-2">
				<input type="number" class="form-control" name="carga" max="240" min="0" value="{{$ficha->carga}}">
			</div>
			<label class="col-sm-2 form-control-label text-xs-right">
				Periodicidade(t)
			</label>
