@extends('layout.app')
@section('titulo')Enviar de Parecer de Bolsa @endsection
@section('pagina')

<div class="title-block">
    <div class="row">
        <div class="col-md-7">
            <h3 class="title">Enviar Parecer de Bolsa/Desconto {{$bolsa}}</h3>
            <p class="title-description">Envia o parecer assinado para o sistema.</p>
        </div>
    </div>
</div>
