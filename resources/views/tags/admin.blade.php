@extends('layout.app')
@section('titulo')Administração das Tags @endsection
@section('pagina')
<style>
    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                ...
                <h3 class="title"> Controle de Tags de Acesso</h3>

                <p class="title-description"> Análise e controle </p>
            </div>
        </div>
    </div>
                                        ...
                                        <ul class="item-list striped">
                                            ...
                                            <li class="item">
                                                <div class="item-row">
                                                    ...
                                                    <div class="item-col fixed item-col-check" > 
                                                        <label class="item-check" >
                                                        <input type="checkbox" class="checkbox" name="turma" value="{{$tag->id}}">
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="item-col item-col codigo">
                                                        ...
                                                        <div > <a href="./analisar/{{$tag->id}} ">{{$tag->id}} </a></div>
                                                    </div>
                                        
                                                    
                                                    <div class="item-col item-col-title pessoa">
                                                        <div class="item-heading">Pessoa</div>
                                                        <div><a href="/secretaria/atender/{{$tag->pessoa}}">{{$tag->getNomePessoa()}}</a></div> 
                                                    </div>


                                                    <div class="item-col item-col pedidoem" >
                                                        <div class="item-heading">código</div>
                                                        <div> 
                                                            <small>{{$tag->tag}}</small>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="item-col item-col">
                                                        ...
                                                        <div> @if($tag->livre_acesso > 0 )
                                                            <span class="badge badge-pill badge-info">Livre Acesso</span>
                                                              @endif
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="item-actions-dropdown">
                                                            ...
                                                            <div class="item-actions-block">
                                                                <ul class="item-actions-list">
                                                                    <li>
                                                                     <a class="edit" title="Aprovar" href="#" onclick="alterarStatusIndividual('aprovar','{{$tag->id}}')"> <i class="fa fa-check-circle-o "></i> </a>
                                                                    </li>
                                                                    <li>
                                                                     <a class="remove" title="Negar" href="#" onclick="alterarStatusIndividual('negar','{{$tag->id}}')"> <i class="fa fa-ban "></i> </a>
                                                                    </li>
                                                                    <li>
                                                                     <a class="edit" title="Colocar para análise" href="#" onclick="alterarStatusIndividual('analisando','{{$tag->id}}')"> <i class="fa fa-clock-o "></i> </a>
                                                                    </li>
                                                                    <li>
                                                                     <a class="remove" title="Cancelar" href="#" onclick="alterarStatusIndividual('cancelar','{{$tag->id}}')"> <i class="fa fa-minus-circle "></i> </a>
                                                                    </li>
...
function alterarStatusIndividual(status,id){
        ...
        if(confirm('Deseja realmente alterar as tags selecionadas?'))
