...
<div class="card card-block">
      <div class="row">
        ...
        <div class="col-md-11">
            <h3 class="title">Fase 6 - Gerando arquivos de remessa</h3>
            <p class="title-description">Os arquivos devem ser enviados antes de serem entregues à gráfica.</p>
            <br>
        </div>
      </div>
      ...
      <div class="form-group row"> 
        ...
        <div class="col-sm-5"> 
          <div class="input-group">
           <div id="progressbar4"><div class="progress-label">{{ceil($boletos->currentPage()*100/$boletos->lastPage())}}%</div></div>
          </div>
        </div>
      </div>
      <div class="form-group row"> 
