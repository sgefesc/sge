	...
	<tr>
		<td colspan="2">
                ...
                <p>
                    ...
                    &nbsp;endereço:&nbsp;<span id="FormView1_Label9" style="font-weight:bold;">{{$pessoa->logradouro}}, {{$pessoa->end_numero}}</span>
                    &nbsp;, bairro:&nbsp;<span id="FormView1_Label10" style="font-weight:bold;">{{$pessoa->bairro}}</span>
                ...
                <p>
                    ...
                    @foreach($inscricoes as $insc)
                        ...
                        @endif    
                            - toda {{ucwords(implode(', ', $insc->turmac->dias_semana )) }} 
                         feira(s), das {{$insc->turmac->hora_inicio}} às {{$insc->turmac->hora_termino}}</span>&nbsp;do programa
                                    <span id="FormView1_PRMDes" style="font-weight:bold;">{{$insc->turmac->programa->nome}}</span></strong>
                ...
                @foreach($inscricoes as $insc)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endif    
                                    - toda {{ucwords(implode(', ', $insc->turmac->dias_semana )) }} 
                                 feira(s), das {{$insc->turmac->hora_inicio}} às {{$insc->turmac->hora_termino}}
                            </td>
                            <td>{{$insc->turmac->data_inicio}}</td>
                            <td>{{$insc->turmac->data_termino}}</td>                           
                             <td>{{$insc->turmac->carga}}</td>
