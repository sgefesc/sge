	...
	<tr>
		<td colspan="2">
                ...
                <p>
                    ...
                    <strong>1.1</strong> O presente formaliza a inscrição do ALUNO nas seguintes atividades:</p>
                    <span id="FormView1_AluNom" style="font-weight:bold;">[Dados do curso esolhido]</span>
                  
                <p>
                    <strong> 2. VALOR E CONDIÇÕES DE PAGAMENTO</strong>
                        <br />
                        2.1 O ALUNO pagará à FESC, pela prestação dos serviços ora ajustados, o valor de [valor do curso] referente ao curso/ano frequentado, dividido em [numero de parcelas do curso] parcelas
                    ...
                    <strong>7. OBRIGAÇÕES GERAIS</strong><br />
                        ...
                        <br>
                        7.8 A FESC não se responsabiliza por possíveis oscilações de conexão ocasionadas por provedores de internet utilizados pelo aluno, nem por eventuais interrupções por ocasião da transmissão das aulas, motivado por perdas, oscilações ou diminuição de sinal de internet.
                        <br>
                        7.9 O (a) aluno (a) declara ceder o direito de uso de imagem e voz, podendo a instituição reproduzi-la ou divulgá-la para fins exclusivamente educacionais, sem quaisquer ônus presentes ou futuros por tempo indeterminado, ainda que egresso da Instituição.
                        <br>
                        7.10 É de exclusiva responsabilidade do usuário o sigilo da senha de acesso ao ambiente virtual de aprendizagem, não cabendo a FESC responsabilidade por eventuais danos decorrentes de uso indevido de senha, ainda que por terceiros.
                        <br>
                        7.11 Os direitos de propriedade sobre todos os ícones, textos, mensagens e imagens, assim como sobre o nome e marcas da FESC, a ela pertencem, sendo expressamente vedado ao aluno (a) transmitir, veicular, distribuir, modicar quaisquer aulas, ícones, textos, mensagens ou imagens contidos nos livros, vídeo-aulas e demais materiais didáticos.
                        <br>   
                        7.12 Caberá ao aluno (a) acessar o ambiente de aprendizagem nos dias e horários de seu curso, não cabendo a FESC reposição de aulas perdidas, salvo em eventuais casos de problemas na transmissão das aulas por parte da instituição.
                        <br>
                        7.13 A FESC é responsável por ministrar aulas, em conformidade com o conteúdo programático proposto.
                        <br>
                        7.14. O (a) aluno (a) terá acesso ao ambiente virtual de aprendizagem durante a vigência de seu curso.
                        <br>
                        7.15 A FESC se reserva o direito de efetuar eventuais manutenções em seus sistemas, visando melhoria na qualidade do serviço prestado.
                        <br>
                ...
                <div align="right">
                    <p>
                    <strong>O contrato com os dados do aluno e assinatura do presidente será disponibilizado após a matrícula.</strong>
                    </p>
                </div>
