      ...
      <div class="container">
        <div class="row top justify-content-center">    
          <div class="col-md-7">
            ...
            <p class="mb-4"> Preencha seu endereço de e-mail para receber seu link que redefinição de senha</p>
            <div id="error"  class="alert alert-danger hide" role="alert" >
              <strong>Falha</strong>: e-mail não corresponde.
            </div>
            @if($errors->any())
        ...
        @endif
            <form method="POST" action="?">
              <div class="form-group first">
                ...
                <input type="email" class="form-control"  name="email" id="email" maxlength="255" max-size="255" minlength='4' required>
              </div> 
            
              <input type="hidden" name="cpf" value="{{request()->cpf}}">              
              <input type="submit" value="Receber Link" class="btn btn-block btn-primary" >
