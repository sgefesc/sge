...
<div class="title-block">
    <h3 class="title"> Nova turma por ficha técnica<span class="sparkline bar" data-type="bar"></span> </h3>
</div>
@include('inc.errors')
<form name="item" method="POST">
    <div class="card card-block">
		...
		<div class="form-group row"> 
			...
			<div class="col-sm-2"> 
				<input type="number" class="form-control boxed" name="idade_min" title="Idade mínima permitida para matrícula" min="0" max="99" value="{{$ficha->idade_min}}"> 
			</div>
			<label class="col-sm-2 form-control-label text-xs-right">
				Idade Máxima
			</label>
			<div class="col-sm-2"> 		 
					<input type="number" class="form-control boxed" name="idade_max" min="0" max="99" title="Idade máxima permitida para matrícula" value="{{$ficha->idade_max}}">			
			</div>
		</div>
		<div class="subtitle-block">
			<br>
