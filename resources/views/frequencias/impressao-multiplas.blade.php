...
<table cellpadding="0" cellspacing="0" dir="ltr" style="table-layout:fixed;font-size:11pt;font-family:Calibri;width:0px; page-break-after: always;" xmlns="http://www.w3.org/1999/xhtml">
	...
	<tr>
		...
		<strong>{{$turma->programa->nome}}</strong></td>
		<td class="stilo2">
		</td>
		<td class="stilo2">
		</td>
	...
	<tr style="height:17px;">
		...
		Término</td>
		<td data-sheets-numberformat="[null,2,&quot;dd/mm/yy&quot;,1]" style="overflow:hidden;padding:0px 3px 0px 3px;vertical-align:bottom;font-size:8pt;color:#000000;">{{$turma->inscritos->first()->turma->data_termino}}
		</td>
	</tr>
