...
return [
    ...
    | pela classe de validador. Algumas destas regras têm várias versões,
    ...
    */
    ...
    | Isso torna rápido especificar uma linha de idioma personalizada para
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar o nosso
    | espaço reservado de atributo com algo mais amigável para o leitor,
    | como "Endereço de E-Mail" em vez de "email". Isso simplesmente nos
