...
class Sala extends Model
{
    ...
    public static function getUsoLivre(){
        ...
        $uso_livre = \App\Models\Models\Sala::select('salas.id as id_sala','locais.id as id_local', 'locais.nome as local', 'salas.nome as sala')
            ->where('obs','like','%Uso Livre%')
            ->join('locais','salas.local','locais.id')
            ->orderBy('locais.nome')
            ->get();
        //$salas = \App\Models\Models\Sala::whereIn('salas.id',$uso_livre);
