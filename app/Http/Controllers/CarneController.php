...
class CarneController extends Controller
{
	...
	public function carneFase1(){
		$pessoas = array();
		$matriculas = \App\Models\Matricula::whereIn('status',['ativa','pendente','espera'])->where('data','>','2022-11-01')->paginate(50);
		//$matriculas = \App\Models\Matricula::where('status','ativa')->where('obs','like','%IP%')->paginate(50);
		//dd($matriculas);
